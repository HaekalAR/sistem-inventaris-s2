        ...
        <div className="w-full h-screen bg-[#12121E] text-white font-jbm md:p-7 flex items-center justify-center">
            <form className="w-1/3 flex flex-col gap-4 bg-[#1D1D29] border border-[#1f1f2e] rounded-lg p-7 shadow-md shadow-[#0c0a11]">
                ...
                <div className="text-center text-gray-400">
                    <p><a href="/register" className="underline text-blue-500">Register</a> if you do not have an account yet</p>
                </div>
                <button className="bg-white py-2 px-4 text-[#202020] font-bold rounded-md border border-white hover:cursor-pointer hover:bg-transparent hover:text-white transition-all duration-300">Login</button>
            </form>
        </div>
    )
}
