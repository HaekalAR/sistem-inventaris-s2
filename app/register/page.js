        ...
        <div className="w-full h-screen bg-[#12121E] text-white font-jbm md:p-7 flex items-center justify-center">
            <form action={formAction} className="w-full max-w-md flex flex-col gap-4 bg-[#1D1D29] border border-[#1f1f2e] rounded-lg p-7 shadow-md shadow-[#0c0a11]">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input type="text" id="username" name="username" placeholder="John Doe" className="bg-[#242432] border border-gray-600 rounded-sm focus:outline-0 px-4 py-2 w-full text-gray-200 font-medium" required />
                </div>
                <div className="flex flex-col gap-1">
                ...
                <div className="text-center text-gray-400">
                    <p><Link href="/login" className="underline text-blue-500">Login</Link> if you already have an account</p>
                </div>
                <button
                    disabled={isPending}
